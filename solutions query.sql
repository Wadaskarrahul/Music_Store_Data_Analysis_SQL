...
-- return your list ordered alphabetically by email startinng with A
...
-- we want to find out the most popluar music genre for each country.
-- (we determine the most popluar genre as the genre with highest amount of purchases)
